    ...
    public static void openMenu(Class<? extends Menu> clazz, Class<? extends Menu> laztMenu, Main main) {
        ...
        for (Field field : clazz.getDeclaredFields()) {
            try {
                ...
                field.setAccessible(true);
                field.set(null, field.getType().getDeclaredConstructor(Main.class).newInstance(main));
                System.out.println("[+] Lazy loaded menu: " + field.getType().getSimpleName());
